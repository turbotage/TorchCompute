...
int main() {
	...
	try {
		strp_cpu_adc_anal_specific(1, true);
	}
	catch (c10::Error e1) {
	...
	/*
	try {
		strp_cpu_vfa_anal_specific(1, true);
	}
	catch (c10::Error e1) {
		std::cout << e1.what() << std::endl;
	}
	...
	*/
	...
	try {
		strp_cuda_adc_anal(100000, false);
	}
	catch (c10::Error e1) {
		std::cout << e1.what() << std::endl;
	}
	...
	try {
		strp_cuda_vfa_anal(100000, false);
	}
	catch (c10::Error e1) {
		std::cout << e1.what() << std::endl;
	}
