...
torch::Tensor operator/(const Token& a, const torch::Tensor& b)
{
	...
	case TokenType::ZERO_TYPE:
	{
		...
		return torch::broadcast_to(0.0f / b, outsizes);
	}
	case TokenType::UNITY_TYPE:
	{
...
{
	return NumberToken(0.0f / b.num, b.is_imaginary, tc::tc_broadcast_shapes(a.sizes, b.sizes));
}
...
{
	return NumberToken(-1.0f / b.num, b.is_imaginary, tc::tc_broadcast_shapes(a.sizes, b.sizes));
}
...
{
	return NumberToken(a.num / b.num, a.is_imaginary || b.is_imaginary, tc::tc_broadcast_shapes(a.sizes, b.sizes));
}
